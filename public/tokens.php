                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 block w-full">
                                <tr class="table w-full table-fixed">
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-5/12">Token</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-2/12">Active</th>
                            ...
                            <tbody class="block max-h-114 overflow-y-auto bg-white divide-y divide-gray-200 w-full">
                                ...
                                while ($row = mysqli_fetch_assoc($tokens)): ?>
                                    <tr class="table w-full table-fixed">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-900 w-5/12"><?= htmlspecialchars($row['token']); ?></td>
                                        <td class="px-6 py-4 w-2/12">
                                            <label class="inline-flex items-center cursor-pointer">
                                                <input type="checkbox" class="sr-only peer toggle-active" data-id="<?= $row['id']; ?>" <?= $row['active'] ? 'checked' : ''; ?>>
                                                <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-accent rounded-full peer dark:bg-gray-700 
                                            peer-checked:bg-green-700 relative after:content-[''] after:absolute after:top-[2px] after:left-[2px] 
                            ...
                            fetch('toggle_active.php', {
                                ...
                                .then(data => {
                                    if (!data.success) {
                                        ...
                                        this.checked = !this.checked; // balikin toggle kalau gagal
                                    }
                                })
                                .catch(err => {
                                    alert('Error: ' + err);
